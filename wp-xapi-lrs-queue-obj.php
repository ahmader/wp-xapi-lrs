 ...
 *
 * NOTES:
 * - this class might have been better as an inner class of WP_XAPI_LRS, but since php doesn't do inner classes, we split it off.
 * - this class is intimately linked with WP_XAPI_LRS...
